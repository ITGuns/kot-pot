...
const PUBLIC_ROUTES = ["/", "/menu", "/korean-bbq", "/hot-pot", "/book", "/gallery", "/visit", "/admin/login", "/this-page-does-not-exist"];
const ADMIN_ROUTES = ["/admin", "/admin/reservations", "/admin/menu", "/admin/menu/categories", "/admin/menu/modifiers", "/admin/menu/ayce", "/admin/media", "/admin/hours", "/admin/settings"];
